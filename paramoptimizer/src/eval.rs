...
pub fn score(position: &Position) -> [f32; NUM_PARAMS] {
    // me
    ...
    [
        length_difference as f32,
        distance_to_center as f32,
        food_ownership_difference as f32,
        square_ownership_difference as f32,
    ]
}
